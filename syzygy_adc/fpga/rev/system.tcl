...
proc create_root_design { parentCell } {
  ...
  set HPM0_FPD_M00_axil [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 HPM0_FPD_M00_axil ]
  ...
  set HPM0_FPD_M01_axil [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 HPM0_FPD_M01_axil ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
   CONFIG.DATA_WIDTH {32} \
   CONFIG.FREQ_HZ {100000000.0} \
  ...
  set HPM0_FPD_M02_axil [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 HPM0_FPD_M02_axil ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
   CONFIG.DATA_WIDTH {32} \
   CONFIG.FREQ_HZ {100000000.0} \
  ...
  set HPM0_FPD_M03_axil [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 HPM0_FPD_M03_axil ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
   CONFIG.DATA_WIDTH {32} \
   CONFIG.FREQ_HZ {100000000.0} \
  ...
  set HPM0_FPD_M04_axil [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 HPM0_FPD_M04_axil ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
   CONFIG.DATA_WIDTH {32} \
   CONFIG.FREQ_HZ {100000000.0} \
  ...
  set mpsoc_clk_100 [ create_bd_port -dir O -type clk mpsoc_clk_100 ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {HPM0_FPD_M00_axil:HPM0_FPD_M01_axil:HPM0_FPD_M02_axil:HPM0_FPD_M03_axil:HPM0_FPD_M04_axil} \
   CONFIG.FREQ_HZ {100000000.0} \
 ] $mpsoc_clk_100

  # Create instance: hpm0_intercon, and set properties
  set hpm0_intercon [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 hpm0_intercon ]
  set_property -dict [ list \
   CONFIG.NUM_MI {5} \
   CONFIG.NUM_SI {1} \
 ] $hpm0_intercon
  ...
  set mpsoc [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.4 mpsoc ]
  set_property -dict [ list \
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO0 MIO#GPIO0 MIO#PMU GPI\
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;3FFFFFFF;1|DDR;DDR_HIGH;800000000;800000000;0|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net hpm0_intercon_M00_AXI [get_bd_intf_ports HPM0_FPD_M00_axil] [get_bd_intf_pins hpm0_intercon/M00_AXI]
  connect_bd_intf_net -intf_net hpm0_intercon_M01_AXI [get_bd_intf_ports HPM0_FPD_M01_axil] [get_bd_intf_pins hpm0_intercon/M01_AXI]
  connect_bd_intf_net -intf_net hpm0_intercon_M02_AXI [get_bd_intf_ports HPM0_FPD_M02_axil] [get_bd_intf_pins hpm0_intercon/M02_AXI]
  connect_bd_intf_net -intf_net hpm0_intercon_M03_AXI [get_bd_intf_ports HPM0_FPD_M03_axil] [get_bd_intf_pins hpm0_intercon/M03_AXI]
  connect_bd_intf_net -intf_net hpm0_intercon_M04_AXI [get_bd_intf_ports HPM0_FPD_M04_axil] [get_bd_intf_pins hpm0_intercon/M04_AXI]
  connect_bd_intf_net -intf_net mpsoc_M_AXI_HPM0_FPD [get_bd_intf_pins hpm0_intercon/S00_AXI] [get_bd_intf_pins mpsoc/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net axil_arst_n [get_bd_ports axil_arst_n] [get_bd_pins hpm0_intercon/ARESETN] [get_bd_pins hpm0_intercon/M00_ARESETN] [get_bd_pins hpm0_intercon/M01_ARESETN] [get_bd_pins hpm0_intercon/M02_ARESETN] [get_bd_pins hpm0_intercon/M03_ARESETN] [get_bd_pins hpm0_intercon/M04_ARESETN] [get_bd_pins hpm0_intercon/S00_ARESETN] [get_bd_pins proc_sys_reset/peripheral_aresetn]
  connect_bd_net -net axil_rst [get_bd_ports axil_rst] [get_bd_pins proc_sys_reset/peripheral_reset]
  connect_bd_net -net mpsoc_clk0 [get_bd_ports mpsoc_clk_100] [get_bd_pins hpm0_intercon/ACLK] [get_bd_pins hpm0_intercon/M00_ACLK] [get_bd_pins hpm0_intercon/M01_ACLK] [get_bd_pins hpm0_intercon/M02_ACLK] [get_bd_pins hpm0_intercon/M03_ACLK] [get_bd_pins hpm0_intercon/M04_ACLK] [get_bd_pins hpm0_intercon/S00_ACLK] [get_bd_pins mpsoc/maxihpm0_fpd_aclk] [get_bd_pins mpsoc/pl_clk0] [get_bd_pins proc_sys_reset/slowest_sync_clk]
  connect_bd_net -net pl_resetn [get_bd_pins mpsoc/pl_resetn0] [get_bd_pins proc_sys_reset/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0xA0000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces mpsoc/Data] [get_bd_addr_segs HPM0_FPD_M00_axil/Reg] -force
  assign_bd_address -offset 0xA0080000 -range 0x00080000 -target_address_space [get_bd_addr_spaces mpsoc/Data] [get_bd_addr_segs HPM0_FPD_M01_axil/Reg] -force
  assign_bd_address -offset 0xA0100000 -range 0x00008000 -target_address_space [get_bd_addr_spaces mpsoc/Data] [get_bd_addr_segs HPM0_FPD_M02_axil/Reg] -force
  assign_bd_address -offset 0xA0108000 -range 0x00008000 -target_address_space [get_bd_addr_spaces mpsoc/Data] [get_bd_addr_segs HPM0_FPD_M03_axil/Reg] -force
  assign_bd_address -offset 0xA0110000 -range 0x00008000 -target_address_space [get_bd_addr_spaces mpsoc/Data] [get_bd_addr_segs HPM0_FPD_M04_axil/Reg] -force
