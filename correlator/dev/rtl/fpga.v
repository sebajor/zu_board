...
wire signed [15:0] adc0, adc1;
assign adc0 = $signed(adc0_signed);
assign adc1 = $signed(adc1_signed);

wire signed [63:0] aa,bb,ab_re,ab_im;
wire correlation_valid;

//correlator input hardcoded to 16 bits...
r22sdf_correlator1024 correlator_inst 
 (
    ...
    .s_r11_axil_awvalid(HPM0_FPD_M01_axil_awvalid),
    .s_r11_axil_awready(HPM0_FPD_M01_axil_awready),
    .s_r11_axil_wdata(HPM0_FPD_M01_axil_wdata),
    .s_r11_axil_wstrb(HPM0_FPD_M01_axil_wstrb),
    .s_r11_axil_wvalid(HPM0_FPD_M01_axil_wvalid),
    .s_r11_axil_wready(HPM0_FPD_M01_axil_wready),
    .s_r11_axil_bresp(HPM0_FPD_M01_axil_bresp),
    .s_r11_axil_bvalid(HPM0_FPD_M01_axil_bvalid),
    .s_r11_axil_bready(HPM0_FPD_M01_axil_bready),
    .s_r11_axil_araddr(HPM0_FPD_M01_axil_araddr),
    .s_r11_axil_arvalid(HPM0_FPD_M01_axil_arvalid),
    .s_r11_axil_arready(HPM0_FPD_M01_axil_arready),
    .s_r11_axil_arprot(HPM0_FPD_M01_axil_arprot),
    .s_r11_axil_rdata(HPM0_FPD_M01_axil_rdata),
    .s_r11_axil_rresp(HPM0_FPD_M01_axil_rresp),
    .s_r11_axil_rvalid(HPM0_FPD_M01_axil_rvalid),
    .s_r11_axil_rready(HPM0_FPD_M01_axil_rready),
    .s_r22_axil_awaddr(HPM0_FPD_M02_axil_awaddr),
    .s_r22_axil_awprot(HPM0_FPD_M02_axil_awprot),
    .s_r22_axil_awvalid(HPM0_FPD_M02_axil_awvalid),
    .s_r22_axil_awready(HPM0_FPD_M02_axil_awready),
    .s_r22_axil_wdata(HPM0_FPD_M02_axil_wdata),
    .s_r22_axil_wstrb(HPM0_FPD_M02_axil_wstrb),
    .s_r22_axil_wvalid(HPM0_FPD_M02_axil_wvalid),
    .s_r22_axil_wready(HPM0_FPD_M02_axil_wready),
    .s_r22_axil_bresp(HPM0_FPD_M02_axil_bresp),
    .s_r22_axil_bvalid(HPM0_FPD_M02_axil_bvalid),
    .s_r22_axil_bready(HPM0_FPD_M02_axil_bready),
    .s_r22_axil_araddr(HPM0_FPD_M02_axil_araddr),
    .s_r22_axil_arvalid(HPM0_FPD_M02_axil_arvalid),
    .s_r22_axil_arready(HPM0_FPD_M02_axil_arready),
    .s_r22_axil_arprot(HPM0_FPD_M02_axil_arprot),
    .s_r22_axil_rdata(HPM0_FPD_M02_axil_rdata),
    .s_r22_axil_rresp(HPM0_FPD_M02_axil_rresp),
    .s_r22_axil_rvalid(HPM0_FPD_M02_axil_rvalid),
    .s_r22_axil_rready(HPM0_FPD_M02_axil_rready),
    .s_r12_axil_awaddr(HPM0_FPD_M03_axil_awaddr),
    .s_r12_axil_awprot(HPM0_FPD_M03_axil_awprot),
    .s_r12_axil_awvalid(HPM0_FPD_M03_axil_awvalid),
    .s_r12_axil_awready(HPM0_FPD_M03_axil_awready),
    .s_r12_axil_wdata(HPM0_FPD_M03_axil_wdata),
    .s_r12_axil_wstrb(HPM0_FPD_M03_axil_wstrb),
    .s_r12_axil_wvalid(HPM0_FPD_M03_axil_wvalid),
    .s_r12_axil_wready(HPM0_FPD_M03_axil_wready),
    .s_r12_axil_bresp(HPM0_FPD_M03_axil_bresp),
    .s_r12_axil_bvalid(HPM0_FPD_M03_axil_bvalid),
    .s_r12_axil_bready(HPM0_FPD_M03_axil_bready),
    .s_r12_axil_araddr(HPM0_FPD_M03_axil_araddr),
    .s_r12_axil_arvalid(HPM0_FPD_M03_axil_arvalid),
    .s_r12_axil_arready(HPM0_FPD_M03_axil_arready),
    .s_r12_axil_arprot(HPM0_FPD_M03_axil_arprot),
    .s_r12_axil_rdata(HPM0_FPD_M03_axil_rdata),
    .s_r12_axil_rresp(HPM0_FPD_M03_axil_rresp),
    .s_r12_axil_rvalid(HPM0_FPD_M03_axil_rvalid),
    .s_r12_axil_rready(HPM0_FPD_M03_axil_rready)
);
...
//Here I need to set some masking to just accept some channels
