...
r22sdf_fft_stage #(
    ...
    .TWIDDLE_WIDTH(16),
    .TWIDDLE_POINT(14),
    .TWIDDLE_FILE("/home/seba/Workspace/verilog_codes/work_in_progress/fft/r22sdf/fft_generator/twiddles/stage512_16_14"),
    .DELAY_BUTTERFLIES(0),
    .DELAY_TYPE("RAM")
...
r22sdf_fft_stage #(
    ...
    .TWIDDLE_WIDTH(16),
    .TWIDDLE_POINT(14),
    .TWIDDLE_FILE("/home/seba/Workspace/verilog_codes/work_in_progress/fft/r22sdf/fft_generator/twiddles/stage128_16_14"),
    .DELAY_BUTTERFLIES(0),
    .DELAY_TYPE("RAM")
...
r22sdf_fft_stage #(
    ...
    .TWIDDLE_WIDTH(16),
    .TWIDDLE_POINT(14),
    .TWIDDLE_FILE("/home/seba/Workspace/verilog_codes/work_in_progress/fft/r22sdf/fft_generator/twiddles/stage32_16_14"),
    .DELAY_BUTTERFLIES(0),
    .DELAY_TYPE("RAM")
) r22sdf_fft_stage_32 (
    .clk(clk),
...
r22sdf_fft_stage #(
    ...
    .TWIDDLE_WIDTH(16),
    .TWIDDLE_POINT(14),
    .TWIDDLE_FILE("/home/seba/Workspace/verilog_codes/work_in_progress/fft/r22sdf/fft_generator/twiddles/stage8_16_14"),
    .DELAY_BUTTERFLIES(0),
    .DELAY_TYPE("RAM")
) r22sdf_fft_stage_8 (
    .clk(clk),
...
r22sdf_fft_stage #(
    ...
    .TWIDDLE_WIDTH(16),
    .TWIDDLE_POINT(14),
    .TWIDDLE_FILE("/home/seba/Workspace/verilog_codes/work_in_progress/fft/r22sdf/fft_generator/twiddles/stage2_16_14"),
    .DELAY_BUTTERFLIES(0),
    .DELAY_TYPE("DELAY")
) r22sdf_fft_stage_2 (
    .clk(clk),
